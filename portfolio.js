...
(function () {
    ...
    $(document).ready(function () {
        var links = [
            {
                name: 'discord',
                link: 'https://discord.gg/nAb2WG5keY'
            },
                
            {
                name: 'youtube',
                link: 'https://www.youtube.com/channel/UCmwQNu5J_R5Q_HUbRZ0ZP_Q'
            },

            {
                name: 'github',
                link: 'https://github.com/tkn-xyz'
            },

            {
                name: 'tiktok',
                link: 'https://www.t.me/danielkilla'
            },
        ];
        ...
        for (var i in links) {
            ...
            if (i != links.length - 1) 
                $('#marquee').append(' <shortcut icon="emoticon" src="assets/others/9252209qwe88327690250.png	"> ');
        }
    ...
    (function () {
        $.getJSON('https://freegeoip.app/json/', function (data) {
            ...
            writeLine(["<span style='font-size: 14px; color: #00aff2;'>Welcome</span>...", "Granting access to <span style='font-size: 14px; color: #06d;'>[tkn.xyz]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #FF0000'>tkn.xyz</i>"], 120, 500, function () {
